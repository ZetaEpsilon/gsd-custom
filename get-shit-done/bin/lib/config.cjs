...
const VALID_CONFIG_KEYS = new Set([
  ...
  'response_language',
  'routing.codex_enabled',
  'routing.gemini_enabled',
  'routing.gemini_never_solo',
  'routing.codex_sandbox',
  'routing.codex_approval',
  'routing.fallback_silent',
...
const CONFIG_KEY_SUGGESTIONS = {
  ...
  'routing.codex': 'routing.codex_enabled',
  'routing.gemini': 'routing.gemini_enabled',
  'workflow.review_gate': 'workflow.review_before_execute',
};
