...
- Every `type="auto"` task must include `ai="..."`:
  - `ai="codex"` for code-heavy implementation
  - `ai="opus"` for planning/docs/orchestration tasks
  - `ai="opus+codex"` for mixed draft-and-refine work
